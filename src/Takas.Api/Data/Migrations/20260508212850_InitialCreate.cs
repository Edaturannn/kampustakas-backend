        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedMinPrice = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    EstimatedMaxPrice = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    SenderId = table.Column<int>(type: "integer", nullable: false),
                    OfferedProductId = table.Column<int>(type: "integer", nullable: true),
                    CashAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_Products_OfferedProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryVerifications_Offers_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryVerifications_Code",
                table: "DeliveryVerifications",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryVerifications_OfferId",
                table: "DeliveryVerifications",
                column: "OfferId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_OfferedProductId",
                table: "Offers",
                column: "OfferedProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Offers_ProductId_SenderId_Status",
                table: "Offers",
                columns: new[] { "ProductId", "SenderId", "Status" });
